...
class excel_data():
	...
	def open_sheet(self):
		if not (os.path.isfile('/home/vivek/Desktop/Stefano/Code/Algo2/Data/'+self.ticker+'.xlsx')):
			self.wb = Workbook()
			...
			self.wb = load_workbook('/home/vivek/Desktop/Stefano/Code/Algo2/Data/'+self.ticker+'.xlsx')
	...
	def close_sheet(self):
		self.wb.save('/home/vivek/Desktop/Stefano/Code/Algo2/Data/'+self.ticker+'.xlsx')
